    ...
    switch (key) {
      ...
      case failedKey: {
        ...
        if (typeof data === 'object') {
          ...
          // the failed message has come from failed stalled job and we only have jobId
          this.emit('global:failed', data, new Error('job stalled more than maxStalledCount'));
        }
        break;
      }
      case drainedKey:
